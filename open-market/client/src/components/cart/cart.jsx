  ...
  return (
    <>
      ...
      {cart.length === 0 ? (
        ...
        return <CartList key = {`key-${cart.id}`} cart = {cart} setCart = {setCart} 
      ...
      {cart.length === 0 ? "" : <TotalCart total = {total} setTotal = {setTotal} found = {found}
      cart = {cart} convertPrice ={convertPrice}/>}
    </>
  );
};
